...
public class SaveService {
    ...
    /**
     * Load a Test tree from an in-memory JMX document.
     *
     * <p>This overload is intended for hosts that own the document lifecycle,
     * such as an IDE editor. The supplied stream is closed before this method
     * returns.</p>
     *
     * @param inputStream stream containing the JMX document
     * @return the loaded tree
     * @throws IOException if there is a problem reading or processing the stream
     */
    public static HashTree loadTree(InputStream inputStream) throws IOException {
        try (BufferedInputStream bufferedInputStream = new BufferedInputStream(inputStream)) {
            return readTree(bufferedInputStream, null);
        }
    }
