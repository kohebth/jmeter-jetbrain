...
final class JMeterStructureViewElement implements StructureViewTreeElement, ItemPresentation {
    private final Project project;
    private final VirtualFile file;
    private final JMeterStructureNode structureNode;

    JMeterStructureViewElement(Project project, VirtualFile file, JMeterStructureNode structureNode) {
