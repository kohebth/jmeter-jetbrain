...
final class JMeterRunTreeBuilder {
    private JMeterRunTreeBuilder() {
    }

    static HashTree fullPlan(JMeterTreeModel model) {
        return JMeterTreeLoader.toRunHashTree(model);
    }

    static HashTree selectedThreadGroup(JMeterTreeModel model, JMeterTreeNode selected) {
