...
final class JMeterRunLifecycle {
    ...
    JMeterRunLifecycle(JMeterRunController.Listener listener, AtomicBoolean running, int engines) {
        this.listener = listener;
        this.running = running;
        this.remaining = new AtomicInteger(engines);
    }

    void started(String host) {
    ...
    void forceFinish(String status, String log) {
        finish(status, log);
    }
